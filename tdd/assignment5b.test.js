...
const { default: pool } = await import("../db/pg-pool.js");
const {
  index,
  show,
  create,
...
const { logon, register, logoff } = await import(
...
const userSchemaModule = await import("../validation/userSchema.js").catch(
  () => null,
);
const taskSchemaModule = await import("../validation/taskSchema.js").catch(
  () => null,
);
userSchema = userSchemaModule?.userSchema ?? null;
taskSchema = taskSchemaModule?.taskSchema ?? null;
patchTaskSchema = taskSchemaModule?.patchTaskSchema ?? null;
